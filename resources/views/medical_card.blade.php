...
@section('content')
    <div class="user-panel">
        <div class="medical-card">
            <form action="{{ route('addMedicalCard') }}"
                  method="GET"
                  class="form-horizontal medical-card-form">
                <div class="form-group medical-card-title">
                    <label for="medical_card"
                           class="control-label col-md-10">
                        Medical card {{ Auth::user()->first_name }} {{ Auth::user()->last_name  }}
                    </label>
                </div>
                <div class="form-group">
                    <label for="postal_address" class="control-label col-md-4">
                        Postal address:
                    </label>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="chronic_disease" class="control-label col-md-4">
                        Chronic disease:
                    </label>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="allergy" class="control-label col-md-4">
                        Allergy:
                    </label>
                    <div class="col-md-6">
